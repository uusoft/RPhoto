  ...
  <div class="content">
		<div class="grid">
			<div class="g1024 space-bot">
				...
				<div class="row space-bot">
					<h2>后台管理</h2>
					<p class="note" style="padding:30px;font-size:20px;font-weight:bold;line-height:200%;">
					<a class="yahei" href="./admin/admin_user.jsp">用户管理</a> <br/>
				    <a class="yahei" href="./admin/admin_album.jsp">专辑管理</a> <br/>
					<a class="yahei" href="./admin/statistics.jsp">统计</a> <br/>
					</p>
				</div>
